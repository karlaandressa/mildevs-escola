...
public class AlunoDAO {
    ...
    public AlunoDAO() {
        this.manager = manager = Persistence.createEntityManagerFactory("escola").createEntityManager();
    }

    //  CRIAR 
    private boolean criaAluno(Aluno aluno){
    ...
    public boolean removeAluno(int matricula){
        ...
        manager.getTransaction().begin();
        manager.persist(alunoASerRemovido);
        manager.getTransaction().commit();
        return true;
